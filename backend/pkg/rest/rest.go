...
func NewFiberHttpServer(authManager auth.AuthManager, projectManager projects.ProjectManager, productManager products.ProductsManager) *fiber.App {
	...
	addV1(app, authManager, projectManager, productManager)
